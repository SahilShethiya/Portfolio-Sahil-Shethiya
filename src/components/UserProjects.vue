...
<div class="user-projects-component">
    ...
    <div class="lg:flex lg:flex-wrap" :class="{'lg:flex lg:flex-wrap lg:items-center lg:justify-center' : orientation}">
        <div class="lg:flex lg:items-center lg:flex-col lg:w-1/2 xl:w-1/3" v-for="(project,index) in filteredProjects" :key="index" :class="{'lg:flex-col lg:w-2/5' : orientation}">
            <div class="card h-full lg:flex lg:flex-col">
                <div :class="{'lg:w-full' : orientation}">
                    <img class="h-64 rounded-12px object-contain mx-auto" :src="require(`@/assets/images/${project.photo}`)" :alt="project.title">
                </div>
                <div class="mt-6 p-4 lg:flex-1 lg:flex lg:flex-col" :class="{'lg:w-full' : orientation}">
                    <div class="lg:flex-1">
                        <h3 class="font-primary font-semibold text-xl text-black-1 leading-7">{{ project.title }}</h3>
                        <div class="mt-4">
                            <p class="font-primary font-normal text-sm leading-5 text-gray-3" v-html="project.description"></p>
                        </div>
                    </div>
                    <div>
                        <div class="flex mt-4">
