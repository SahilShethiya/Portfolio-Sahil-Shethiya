...
<div class="user-blogs-component lg:w-1/2 lg:w-full">
    ...
    <div>
        <div v-for="(blog,index) in data" :key="index" class="flex flex-col items-center justify-center card">
            ...
            <div>
                <p class="font-primary font-medium text-base leading-5 text-gray-4">Blog</p>
                <!-- Blog title -->
                <div class="mt-6">
                <h3 class="font-primary font-medium text-2xl text-blue-1 leading-8" style="text-align: center"><a :href="`${blog.link}`" target="_blank">{{blog.title}}</a></h3>
                </div>
                <!-- Blog Description -->
                <div class="mt-6">
                <p class="font-primary font-medium text-base leading-5 text-gray-3" style="text-align: justify; text-justify: inter-word;" v-html="blog.description"></p>
                </div>
            </div>
        </div>
    </div>
